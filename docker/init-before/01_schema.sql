...
CREATE TABLE alert_transactions (
  ...
  updated_at    DATETIME       NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新日時',
  PRIMARY KEY (id),
  CONSTRAINT fk_alert_transactions_user
    FOREIGN KEY (user_id) REFERENCES users(id)
...
CREATE TABLE alert_users (
  ...
  updated_at    DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新日時',
  PRIMARY KEY (id),
  CONSTRAINT fk_alert_users_user
    FOREIGN KEY (user_id) REFERENCES users(id)
...
CREATE TABLE alert_user_comments (
  ...
  updated_at    DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新日時',
  PRIMARY KEY (id),
  CONSTRAINT fk_alert_user_comments_alert_user
    FOREIGN KEY (alert_user_id) REFERENCES alert_users(id)
...
CREATE TABLE alert_user_investigations (
  ...
  updated_at      DATETIME    NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新日時',
  PRIMARY KEY (id),
  CONSTRAINT fk_alert_user_investigations_alert_user
    FOREIGN KEY (alert_user_id) REFERENCES alert_users(id)
...
CREATE TABLE alert_investigation_transactions (
  ...
  CONSTRAINT fk_alert_inv_transactions_investigation
    FOREIGN KEY (alert_user_investigation_id)
    REFERENCES alert_user_investigations(id)
